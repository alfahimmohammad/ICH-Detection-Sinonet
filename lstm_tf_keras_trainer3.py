...
del model 
model = getLSTM3()
model.load_weights(saved_model_dir+'/LSTM3-017-0.906857.h5')
...
#%%
checkpoint = ModelCheckpoint(saved_model_dir+'/LSTM3-{epoch:03d}-{val_auc:03f}.h5', monitor = 'val_auc', verbose = 0, save_best_only = True,
    save_weights_only = True, mode = 'max')

csv_logger = CSVLogger(saved_model_dir+'/LSTM3-8882_training_history.csv', append=True, separator=',')
"""
...
np.save('roc_curve/fpr_GRU4-features.npy', fpr)
np.save('roc_curve/tpr_GRU4-features.npy', tpr)
plt.figure()
lw = 2
